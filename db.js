/**
 * Created by janghunlee on 2017. 11. 5..
 */
...
mongoose.connect("mongodb://localhost/elec", (err) => {
    if(err){
...
function requestDB(num){
    ...
    var options = {
        url: 'https://openapi.naver.com/v1/search/local.json?display=9&start='+ num +'&query='+urlencode('광주공중전화'),
        headers: {
